...
## simulate data
msfs = simSFS_model1(theta, N1, N2, N3, migration, msT1, msT12)

## save sfs to file
i = 1
bootname = "pboots/m1."+str(i)+".boot"
...
outfile = open("dadi_m1_f1_boots.txt","a")
print >>outfile, "\t".join(["boot"+str(i)]+map(str,list(popt)+[ll_opt]))
print "\t".join(["FINALboot"+str(i)]+map(str,list(popt)+[ll_opt]))
outfile.close()

########## optimize under model 2  ##########################################
print "optimizing model 2"
...
outfile = open("dadi_m1_f2_boots.txt","a")
print >>outfile, "\t".join(["boot"+str(i)]+map(str,list(popt)+[ll_opt]))
print "\t".join(["FINALboot"+str(i)]+map(str,list(popt)+[ll_opt]))
outfile.close()

########## optimize under model 3  ##########################################
print "optimizing model 3"
...
outfile = open("dadi_m1_f3_boots.txt","a")
print >>outfile, "\t".join(["boot"+str(i)]+map(str,list(popt)+[ll_opt]))
print "\t".join(["FINALboot"+str(i)]+map(str,list(popt)+[ll_opt]))
outfile.close()
############################################################################
